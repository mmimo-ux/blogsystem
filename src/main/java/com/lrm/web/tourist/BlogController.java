...
public class BlogController {
    ...
    private static final String INPUT = "tourist/blogs-input";
    private static final String LIST = "tourist/blogs";
    private static final String REDIRECT_LIST = "tourist/blogs :: blogList";
    ...
    public String blogs(@PageableDefault(size = 8, sort = {"updateTime"}, direction = Sort.Direction.DESC)
        ...
        model.addAttribute("page", blogService.findByUserId(user.getId(), pageable));
    ...
    public String post(Blog blog, RedirectAttributes attributes, HttpSession session) {
        ...
        blog.setUser((User) session.getAttribute("tuser"));
        ...
        if (b == null) {
            ...
            attributes.addFlashAttribute("message", "操作成功! （若是发布文章，请等待管理员审核）");
        }

        return "redirect:/tourist/blogs";
